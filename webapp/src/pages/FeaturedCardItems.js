...
import imafff from "../../src/images/Cat05.jpg";
  ...
  return (
    <>
      <Card className="featured_card">
        <Card.Img className="featured_card_img" variant="top" src={imafff} />
        ...
        <Card.Body className="featured_card_body">
          ...
          >
            <Card.Text className="featured_card_price">
              LKR : {props.price}
            </Card.Text>
          </div>

          <Link to="/ViewSpaceDetails">
            <Button className="featured_card_btn" variant="primary">
              VIEW
            </Button>
          </Link>
        </Card.Body>
