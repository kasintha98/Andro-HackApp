...
function PaymentModel({ orderTotal }, props) {
  ...
  window.payhere.onCompleted = function onCompleted(orderId) {
    ...
    let newBook = {
      buyer_id: user,
      space_id: "610356d3f3ebb20022060355",
      date: props.startDate,
    };

    Axios.post(`${constants.backend_url}/book/addbooking`, newBook).then(
      (res) => {
  ...
  return (
    <>
      <button
        onClick={(e) => pay(e)}
        className="add_product_category_form_btn1"
      >
        Proceed to Pay
      </button>
    </>
